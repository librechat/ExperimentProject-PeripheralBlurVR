...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Boolean SliderDecrease
        {
            get
            {
                return SteamVR_Actions.default_SliderDecrease;
            }
        }
        
        public virtual SteamVR_Action_Boolean SliderIncrease
        {
            get
            {
                return SteamVR_Actions.default_SliderIncrease;
            }
        }
